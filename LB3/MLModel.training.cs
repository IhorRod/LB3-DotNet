    ...
    public partial class MLModel
    {
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Categorical.OneHotEncoding(@"country", @"country", outputKind: OneHotEncodingEstimator.OutputKind.Indicator)      
                                    .Append(mlContext.Transforms.ReplaceMissingValues(new []{new InputOutputColumnPair(@"points", @"points"),new InputOutputColumnPair(@"price", @"price")}))      
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new []{@"country",@"points",@"price"}))      
